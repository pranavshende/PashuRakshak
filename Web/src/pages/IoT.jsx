    ...
    <div>
      <TopHeaderBanner title="IoT Sensor Dashboard" subtitle="Real-time livestock health monitoring">
        <div style={{ textAlign: 'right' }}>
          <div style={{ fontSize: 10, color: 'var(--text-muted)', marginBottom: 4 }}>Last updated</div>
          <div style={{ fontSize: 12, color: 'var(--text-main)', fontWeight: 700 }}>{lastUpdate.toLocaleTimeString()}</div>
        </div>
      </TopHeaderBanner>
        ...
        {data.some(s => s.status === 'warning') && (
          <div className="card mt-4 animate-fade-in" style={{ background: 'var(--risk-moderate-bg)', border: '1px solid rgba(234,179,8,0.3)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              ...
              <div>
                <div style={{ fontSize: 14, fontWeight: 700, color: '#B45309' }}>Attention Required</div>
